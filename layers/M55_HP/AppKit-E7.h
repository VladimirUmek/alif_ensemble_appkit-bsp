...
// CMSIS Driver vStream instances
#define CMSIS_DRIVER_VSTREAM_AUDIO_IN   0     // CMSIS Driver vStream instance number
...
extern vStreamDriver_t    Driver_vStream0; /* Audio In Stream */
